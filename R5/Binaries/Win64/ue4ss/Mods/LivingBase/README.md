...
(decimal)and Marita, each in TWO base bodies (Base 1 = Gatherer, Base 2 = Herbalist -- two
         ...
         distinct outfit (2.1.7); Woman's outfit, hat presence, and hair vary naturally
...
real, distinct outfit (as of 2.1.7 -- not a shared generic look with pieces patched onto
...
each placed NPC was standing in for (and upgrades anyone placed before 2.1.7 to her real
