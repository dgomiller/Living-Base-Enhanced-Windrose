...
Config.MONSTEROUS_STANDING = {
  { faction = "Monsterous", path = "/Game/Gameplay/Character/AI/NPC/QuestStatic/BP_NPC_QuestStatic_Ghost_01_WithFXLogic.BP_NPC_QuestStatic_Ghost_01_WithFXLogic_C", label = "Ghost Pirate" },
}
...
Config.MOBILE_QUEST_NPCS = {
  { faction = "Brethren of the Coast", path = "/Game/Gameplay/Character/AI/NPC/QuestStatic/BP_NPC_QuestStatic_BotC_FrancoisArno.BP_NPC_QuestStatic_BotC_FrancoisArno_C", label = "Francois Arno (Mobile)" },
  ...
  { faction = "Monsterous", path = "/Game/Gameplay/Character/AI/NPC/QuestStatic/BP_NPC_QuestStatic_Ghost_01_WithFXLogic.BP_NPC_QuestStatic_Ghost_01_WithFXLogic_C", label = "Ghost Pirate (Mobile)", menuPath = { "Monsterous", "Walkers" } },
}
