...
Config.SOCKETITEMS_ITEMS = {
  ...
  { asset="/Game/Character/Skeletal_Meshes/Armor/ArmorRegular/Belt/Miscs/SM_Belt_Misc_Powder_01", shortName="SM_Belt_Misc_Powder_01", friendlyName="Powder Horn", sockets={ "soc_Sling01B", "soc_Sling02B", "soc_Sling02F", "soc_Sling03B", "soc_Sling04B", "soc_Strap01B", "soc_Strap01F", "soc_Strap02B", "soc_Strap02F", "soc_Strap03B", "soc_Strap03F", "soc_Strap04B", "soc_beltB", "soc_beltSlingF", "soc_beltStrapB" }, limit=1, tags={}, rarity="Common" },
...
Config.SOCKETITEMS_WEAPONS = {
  ...
  { asset="/Game/Character/Skeletal_Meshes/Weapons/WeaponRange_Pistol/SK_WeaponRange_Pistol_DrakesDoom", shortName="SK_WeaponRange_Pistol_DrakesDoom", friendlyName="Pistol - DrakesDoom", sockets={ "beltSlot_01_lSocket", "beltSlot_01_rSocket" }, tags={ "Hunting", "Soldiering" }, location="Pistol", rarity="Rare" },
